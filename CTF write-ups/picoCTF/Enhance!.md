...
|||
```
At first glance, it just looks like normal `svg` file code, however if we take a closer look, we can see the flag hidden in plain sight, notably in these lines
```
||id="tspan3748">p</tspan><tspan|
||id="tspan3754">i </tspan><tspan|
||id="tspan3756">c </tspan><tspan|
...
||id="tspan3752">c 3 d _ 2 4 3 7 4 6 7 5 }</tspan></text>|
```
Which spells the flag.
Flag: `picoCTF{3nh4nced_24374675}`